...
private RadarSystemSprint1Main sys;
	...
	protected void testTheDistance( boolean ledStateExpected ) {
		...
		ActionFunction endFun = (n) -> { 
			...
			ColorsOut.out("ledState=" + ledState + " ledStateExpected=" + ledStateExpected
					+ " radarDisplayedDistance=" + radarDisplayedDistance, ColorsOut.MAGENTA);
		...
		sys.getController().start( endFun, 1 ); //one-shot
  	    BasicUtils.delay(3000) ; //give time to see ...
	}
